...
PLANETS = {
"Mercury": PlanetCard("Mercury", "Increases High Card hand value by +1 multiplier and +10 chips", 2, 10, 1),
        "Venus": PlanetCard("Venus", "Increases One Pair hand value by +1 multiplier and +15 chips", 2, 15, 1),
        "Earth": PlanetCard("Earth", "Increases Two Pair hand value by +2 multiplier and +15 chips", 2, 15, 2),
        "Mars": PlanetCard("Mars", "Increases Three of a Kind hand value by +2 multiplier and +25 chips", 2, 25, 2),
        "Jupiter": PlanetCard("Jupiter", "Increases Straight hand value by +3 multiplier and +25 chips", 3, 25, 3),
        "Saturn": PlanetCard("Saturn", "Increases Flush hand value by +3 multiplier and +30 chips", 3, 30, 3),
        "Uranus": PlanetCard("Uranus", "Increases Full House hand value by +3 multiplier and +35 chips", 3, 35, 3),
